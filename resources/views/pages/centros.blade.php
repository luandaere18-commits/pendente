...
{{-- Page Hero (azul centralizado, sem breadcrumb) --}}
...
<div class="py-14 bg-background min-h-screen">
    <div class="container mx-auto px-4">
        ...
        {{-- Mapa --}}
        <div class="rounded-2xl overflow-hidden shadow-xl mb-14 border border-border reveal">
        ...
        <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            @foreach($centros as $centro)
                ...
                <div class="feature-card group reveal">
                    ...
                    {{-- Botão que filtra turmas por este centro --}}
