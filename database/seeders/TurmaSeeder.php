...
class TurmaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (isset($cursoIds[1])) {
            ...
            $turmas[] = ['curso_id' => $cursoIds[1], 'duracao_semanas' => 6, 'dia_semana' => json_encode(['Terça', 'Quinta']), 'periodo' => 'tarde', 'hora_inicio' => '13:00', 'hora_fim' => '15:00', 'data_arranque' => '2026-04-05', 'created_at' => $now, 'updated_at' => $now];
        }
        
        if (isset($cursoIds[2])) {
            // Turma 3 - Night schedule (seg, qua, sex) - 8 semanas
            $turmas[] = ['curso_id' => $cursoIds[2], 'duracao_semanas' => 8, 'dia_semana' => json_encode(['Segunda', 'Quarta', 'Sexta']), 'periodo' => 'noite', 'hora_inicio' => '18:30', 'hora_fim' => '20:30', 'data_arranque' => '2026-04-08', 'created_at' => $now, 'updated_at' => $now];
        }
        ...
        if (isset($cursoIds[4])) {
            ...
            $turmas[] = ['curso_id' => $cursoIds[4], 'duracao_semanas' => 10, 'dia_semana' => json_encode(['Segunda', 'Quarta', 'Sexta']), 'periodo' => 'tarde', 'hora_inicio' => '12:30', 'hora_fim' => '14:30', 'data_arranque' => '2026-04-15', 'created_at' => $now, 'updated_at' => $now];
        }
